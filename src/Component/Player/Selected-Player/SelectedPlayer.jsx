...
const AllSelectedPlayers = ({ player,handleRemovePlayer }) => {
  const {
    name,
    country,
    countryFlag,
    ...
    <div className="rounded-lg border p-1">
      ...
      <div className="my-4">
        ...
        <div className="mt-5 flex mx-2 justify-between items-center">
            ...
            <div className="">
                <button onClick={()=>handleRemovePlayer(player)}  className="bg-main-color text-gray-800 font-bold rounded-lg px-3 py-2">Remove Player</button>
            </div>
        </div>
      </div>
    </div>
...
export default AllSelectedPlayers;
